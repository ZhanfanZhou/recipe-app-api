...
def create_recipe(user, **recipe):
    ...
    default = {
        ...
        'time_minutes': 30,
        'price': Decimal('99.99'),
        'link': 'https//recipe.gg/recipe.pdf',
    }
    default.update(recipe)
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        res = self.client.get(RECIPES_URL)
        # Uncomparable recipe objects
        recipes = Recipe.objects.all().order_by('-id')
        # Comparable recipe objects
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='other@example.gg', password='password')
    ...
    def test_create_recipe(self):
        """Test creating a recipe in database."""
        payload = {
            'title': 'Recipe title',
            'description': 'This is a recipe.',
            'time_minutes': 30,
    ...
    def test_create_tag_on_update(self):
        ...
        # Start a new query to return tags, refresh_from_db() is unneccessary.
        self.assertIn(new_tag, recipe.tags.all())

    def test_update_recipe_assign_tag(self):
        """Test updating a recipe with a existing tag."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_ingredients_on_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        # print(payload['ingredients'][0]['name'])
